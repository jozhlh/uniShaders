...
TessellationSphere::TessellationSphere(ID3D11Device* device, ID3D11DeviceContext* deviceContext, WCHAR* textureFilename, float res)
{
	m_resolution = res;
...
void TessellationSphere::SendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
