...
{
	InitShader(L"shaders/tessellation_vs.hlsl", L"shaders/tessellation_hs.hlsl", L"shaders/tessellationDepth_ds.hlsl", L"shaders/depth_ps.hlsl");
}
...
void DepthShader::SetShaderParameters(
